...
public class TestDomainMetaModelPostProcessor
    implements ModelContextDependentPostProcessor
{

    private static final Logger log = LoggerFactory.getLogger(TestDomainMetaModelPostProcessor.class);
    
    private final String domainPrefix;


    public TestDomainMetaModelPostProcessor(String domainPrefix)
    {
    ...
    @Override
    public int handleModel(HandlerContext handlerContext, JavaSourceGenerator sourceGenerator)
        throws MetaGenerationFailedException
    {
        final String DOMAIN_MODEL_TEMPLATE = "templates/java-models/test-domain-meta-model.vtl";
        final String fileName = domainPrefix + "TestDomain.java";

        List<MetaModel> domainTypeMetaModels = handlerContext.getContextForHandlerWithId(HandlerConstants.TEST_DOMAIN_TYPE_MODEL_HANDLER);
        List<MetaModel> externalDomainTypeMetaModels = handlerContext.getContextForHandlerWithId(HandlerConstants.TEST_EXTERNAL_DOMAIN_TYPE_MODEL_HANDLER);
        ...
        context.put("className", domainPrefix + "TestDomain");
        ...
        log.info("Generated test domain class '" + fileName + "' which provides access to all meta models.");
